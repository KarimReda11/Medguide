...
class _FeedbackPageState extends State<FeedbackPage> {
  ...
  submit(String rate, String q1, String q2, String q3, String q4) async {
    ...
    var response = await http.post(
        "https://sara-f0acb.firebaseio.com/feedback.json",
        ...
        onPressed: rateController.text == "" ||
            ...
            : () {
                ...
                submit(rateController.text, q1Controller.text,
                    q2Controller.text, q3Controller.text, q4Controller.text);
              },
        elevation: 0.0,
  ...
  final TextEditingController q4Controller = new TextEditingController();
      ...
      child: Column(
        children: <Widget>[
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              labelText: "what are the problems you face in it?",
              labelStyle: TextStyle(color: Colors.black),
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              labelText: "do you want to add a doctor?",
              labelStyle: TextStyle(color: Colors.black),
              border: UnderlineInputBorder(
                  borderSide: BorderSide(color: Colors.white12)),
              hintStyle: TextStyle(color: Colors.black38),
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              labelText: "Do you have any Recommendation for it?",
              labelStyle: TextStyle(color: Colors.black),
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              labelStyle: TextStyle(color: Colors.black),
              hintText: "if your answer was \'\'yes\'\' ,tell us your comment",
              border: UnderlineInputBorder(
                  borderSide: BorderSide(color: Colors.white12)),
              hintStyle: TextStyle(color: Colors.black38),
            ),
